...
class TestCase(test_env.BaseTestCase):
    ...
    def __perform_test(self, typ):
        name_part = "Long" if typ is yaspy.DB_TYPE_LONG else "LongRaw"
        ...
        for i in range(1, 11):
            ...
            if i % 3 == 1:
                ...
                if typ is yaspy.DB_TYPE_LONG_RAW:
    ...
    def test_2000_longs(self):
        ...
        self.__perform_test(yaspy.DB_TYPE_LONG)
    ...
    def test_2002_long_raws(self):
        ...
        self.__perform_test(yaspy.DB_TYPE_LONG_RAW)
    ...
    def test_2003_long_cursor_description(self):
        ...
        expected_value = [
            ...
            ('LONGCOL', yaspy.DB_TYPE_LONG, None, None, None, None, True)
        ]
    ...
    def test_2004_long_raw_cursor_description(self):
        ...
        expected_value = [
            ('INTCOL', yaspy.DB_TYPE_NUMBER, 10, None, 9, 0, False),
            ('LONGRAWCOL', yaspy.DB_TYPE_LONG_RAW, None, None, None, None,
                    True)
        ]
        self.assertEqual(self.cursor.description, expected_value)
