...
class TestCase(test_env.BaseTestCase):
    ...
    def __return_strings_as_bytes(self, cursor, name, default_type, size,
                                  precision, scale):
        if default_type == yaspy.DB_TYPE_VARCHAR:
    ...
    def test_2502_bind_different_var(self):
        ...
        retval_1 = self.cursor.var(yaspy.VARCHAR, 30)
        retval_2 = self.cursor.var(yaspy.VARCHAR, 30)
    ...
    def test_2504_bind_string_after_number(self):
        ...
        # self.cursor.setinputsizes(value = yaspy.NUMBER)
        self.cursor.execute("""
                select * from TestStrings
                where StringCol = :value""",
                value="String 6")
    ...
    def test_2506_bind_string_array_by_sizes(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        self.cursor.setinputsizes(array=[yaspy.STRING, 10])
        array = [r[1] for r in self.raw_data]
        self.cursor.execute("""
                begin
                  :return_value := pkg_TestStringArrays.TestInArrays(
    ...
    def test_2507_bind_string_array_by_var(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        array = self.cursor.arrayvar(yaspy.STRING, 10, 20)
    ...
    def test_2508_bind_in_out_string_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.STRING, 10, 100)
    ...
    def test_2509_bind_out_string_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.STRING, 6, 100)
    ...
    def test_2510_bind_raw(self):
        ...
        # self.cursor.setinputsizes(value = yaspy.BINARY)
        self.cursor.execute("""
                select * from TestStrings
                where RawCol = :value""",
                value="Raw 4".encode())
    ...
    def test_2512_bind_and_fetch_universal_rowids(self):
        ...
        data = [
            (decimal.Decimal(1), "ABC" * 75, datetime.date(2017, 4, 11)),
            (decimal.Decimal(2), "DEF" * 80, datetime.date(2017, 4, 12))
        ]
        for row in data:
            self.cursor.execute("""
    ...
    def test_2514_bind_out_set_input_sizes_by_type(self):
        ...
        bind_vars = self.cursor.setinputsizes(value=yaspy.STRING)
        self.cursor.execute("""
                begin
                  :value := 'TSI';
                end;""")
    ...
    def test_2518_bind_out_var(self):
        ...
        var = self.cursor.var(yaspy.VARCHAR)
        self.cursor.execute("""
                begin
                  :value := 'TSI (VAR)';
                end;""",
    ...
    def test_2519_bind_in_out_var_direct_set(self):
        ...
        var = self.cursor.var(yaspy.STRING)
    ...
    def test_2520_bind_long_string(self):
        ...
        self.cursor.setinputsizes(big_string=yaspy.DB_TYPE_LONG)
        self.cursor.execute("""
                declare
    ...
    def test_2522_cursor_description(self):
        ...
        expected_value = [
            ...
            ('STRINGCOL', 26, 21, 20 * varchar_ratio, 0, 0, 0),
            ('RAWCOL', 28, 60, 30, None, None, 0),
            ('FIXEDCHARCOL', 24, 41, 40 * varchar_ratio, 0, 0, 0),
            ('NULLABLECOL', 26, 53, 50 * varchar_ratio, 0, 0, 1)
        ]
    ...
    def test_2528_issue_50(self):
        ...
        id_var = cursor.var(yaspy.NUMBER)
        cursor.execute("""
    ...
    def test_2529_set_rowid_to_string(self):
        ...
        var = self.cursor.var(yaspy.ROWID)
        var.setvalue("ABDHRYTHFJGKDKKDH")
    ...
    def test_2531_long_xml_as_string(self):
        ...
        self.cursor.execute("""
                ...
                values (:1, xmltype(:2))""", (int_val, xml_string))
        self.cursor.execute("select t.XMLCol.xml from TestTempXML t where intCol = :1",
                (int_val,))
        actual_value, = self.cursor.fetchone()
