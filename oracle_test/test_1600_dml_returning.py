...
class TestCase(test_env.BaseTestCase):
    ...
    def test_1600_insert(self):
        ...
        int_var = self.cursor.var(yaspy.NUMBER)
        ...
        self.cursor.execute("""
                ...
                int_var=int_var,
                str_var=str_var)
        self.assertEqual(int_var.values, [str(int_val)])
    ...
    def test_1601_insert_many(self):
        ...
        int_var = self.cursor.var(yaspy.NUMBER, arraysize=len(int_values))
    ...
    def test_1604_update_no_rows(self):
        ...
        self.assertEqual(str_var.values, [None])
        self.assertEqual(int_var.getvalue(), None)
        self.assertEqual(str_var.getvalue(), None)
    ...
    def test_1606_update_multiple_rows_executemany(self):
        ...
        self.cursor.executemany("""
                insert into TestTempTable (IntCol, StringCol)
                values (:1, :2)""", data)
        int_var = self.cursor.var(yaspy.NUMBER, arraysize=3)
    ...
    def test_1607_insert_and_return_object(self):
        ...
        out_var = self.cursor.var(yaspy.DB_TYPE_OBJECT,
                                  typename="UDT_OBJECT")
        self.cursor.execute("""
