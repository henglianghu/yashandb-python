...
class TestCase(test_env.BaseTestCase):
    ...
    def output_type_handler_binary_int(self, cursor, name, default_type, size,
                                       precision, scale):
        return cursor.var(yaspy.DB_TYPE_BINARY_INTEGER,
                          arraysize=cursor.arraysize)

    def output_type_handler_decimal(self, cursor, name, default_type, size,
                                    precision, scale):
        if default_type == yaspy.NUMBER:
    ...
    def test_2205_bind_large_long_as_oracle_number(self):
        ...
        in_val = 6088343244
        value_var = self.cursor.var(yaspy.NUMBER)
        value_var.setvalue(in_val)
        self.cursor.execute("""
                begin
                  :value := :value + 5;
                end;""",
    ...
    def test_2206_bind_large_long_as_integer(self):
        ...
        result, = self.cursor.fetchone()
        self.assertEqual(result, str(long_value))
    ...
    def test_2208_bind_decimal_after_number(self):
        ...
        # cursor.setinputsizes(value=yaspy.NUMBER)
        ...
        self.assertEqual(decimal.Decimal(out_value), value)
    ...
    def test_2211_bind_number_array_by_sizes(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        self.cursor.setinputsizes(array = [yaspy.NUMBER, 10])
        array = [r[2] for r in self.raw_data]
        self.cursor.execute("""
                begin
                  :return_value := pkg_TestNumberArrays.TestInArrays(
    ...
    def test_2212_bind_number_array_by_var(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        array = self.cursor.arrayvar(yaspy.NUMBER,
    ...
    def test_2213_bind_zero_length_number_array_by_var(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        array = self.cursor.arrayvar(yaspy.NUMBER, 0)
        self.cursor.execute("""
                begin
                  :return_value := pkg_TestNumberArrays.TestInArrays(
                      :integer_value, :array);
    ...
    def test_2214_bind_in_out_number_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.NUMBER, 10)
    ...
    def test_2215_bind_out_number_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.NUMBER, 6)
    ...
    def test_2216_bind_out_set_input_sizes(self):
        ...
        bind_vars = self.cursor.setinputsizes(value = yaspy.NUMBER)
        self.cursor.execute("""
                begin
                  :value := 5;
                end;""")
    ...
    def test_2218_bind_out_var(self):
        ...
        self.cursor.execute("""
                ...
                value = var)
        self.assertEqual(var.getvalue(), str(5))
    ...
    def test_2220_cursor_description(self):
        ...
        expected_value = [
            ...
            ('LONGINTCOL', 12, 24, 9, 16, 0, 0),
            ('NUMBERCOL', 12, 20, 6, 9, 2, 0),
            ('FLOATCOL', 10, 21, 4, None, None, 0),
            ('UNCONSTRAINEDCOL', 12, 48, 18, 38, None, 0),
            ('NULLABLECOL', 12, 48, 18, 38, 0, 1)
        ]
    ...
    def test_2227_acceptable_boundary_numbers(self):
        ...
        in_values = [decimal.Decimal("9.99999999999999e+125"),
                     ...
                     -1e-130]
        out_values = ['9.99999999999999E+125', '-9.99999999999999E+125',
                      '0', '1.0000000000000001E-130', '-1.0000000000000001E-130']
    ...
    def test_2229_return_float_from_division(self):
        ...
        self.cursor.execute("""
                ...
                where IntCol = 1""")
        result, = self.cursor.fetchone()
        self.assertEqual(float(result), 1.0 / 7.0)
        self.assertTrue(isinstance(result, decimal.Decimal), "float not returned")

    def test_2230_string_format(self):
        "2230 - test that string format is returned properly"
        var = self.cursor.var(yaspy.NUMBER)
        self.assertEqual(str(var), "<yaspy.Var type 26 value>")
        var.setvalue(4)
        self.assertEqual(str(var), "<yaspy.Var type 26 value>")
    ...
    def test_2231_bind_binary_double(self):
        ...
        self.cursor.setinputsizes(yaspy.DB_TYPE_BINARY_DOUBLE)
        self.cursor.execute(statement, (5,))
        self.assertEqual(self.cursor.bindvars[0].type,
                         yaspy.DB_TYPE_BINARY_DOUBLE)
