...
class TestCase(test_env.BaseTestCase):
    ...
    def test_1800_bind_interval(self):
        ...
        # self.cursor.setinputsizes(value=yaspy.DB_TYPE_INTERVAL_DS)
    ...
    def test_1805_bind_out_var(self):
        ...
        var = self.cursor.var(yaspy.TIMEDELTA)
        self.cursor.execute("""
                begin
    ...
    def test_1806_bind_in_out_var_direct_set(self):
        ...
        var = self.cursor.var(yaspy.TIMEDELTA)
        var.setvalue(datetime.timedelta(days=1, minutes=50))
    ...
    def test_1807_cursor_description(self):
        ...
        expected_value = [
            ...
            ('INTERVALCOL', 20, None, 8, 2, 6, 0),
            ('NULLABLECOL', 20, None, 8, 2, 6, 1)
        ]
    ...
    def test_1811_bind_and_fetch_negative_interval(self):
        ...
        self.cursor.execute("select TO_DSINTERVAL(:1) from dual", [value])
