...
class TestCase(test_env.BaseTestCase):
    ...
    def test_1102_app_context_negative(self):
        ...
        self.assertRaises(TypeError, yaspy.connect,
    ...
    def test_1105_bad_connect_string(self):
        ...
        self.assertRaises(yaspy.DatabaseError, yaspy.connect,
    ...
    def test_1107_change_password(self):
        ...
        connection = yaspy.connect(dsn=test_env.get_connect_string(),
                                      user=test_env.get_main_user(),
    ...
    def test_1108_change_password_negative(self):
        ...
        if self.is_on_oracle_cloud(connection):
            self.skipTest("passwords on Oracle Cloud are strictly controlled")
        new_password = "1" * 150
        self.assertRaises(yaspy.DatabaseError, connection.changepassword,
    ...
    def test_1110_encodings(self):
        ...
        connection = yaspy.connect(test_env.get_main_user(),
                                      test_env.get_main_password(),
                                      test_env.get_connect_string())
    ...
    def test_1111_different_encodings(self):
        ...
        value = "\u03b4\u4e2a"
        cursor = connection.cursor()
        nchar_var = cursor.var(yaspy.DB_TYPE_NVARCHAR, 100)
    ...
    def test_1112_exception_on_close(self):
        ...
        connection = test_env.get_connection()
        connection.close()
        self.assertRaises(yaspy.DatabaseError, connection.rollback)
    ...
    def test_1113_connect_with_handle(self):
        ...
        connection2 = yaspy.connect(handle=connection.handle)
        ...
        cursor.close()
        self.assertRaises(yaspy.DatabaseError, connection2.close)
        connection.close()
    ...
    def test_1117_rollback_on_close(self):
        ...
        count, = cursor.fetchone()
        # yasdb carry out commit operation when session disconnected
    ...
    def test_1120_string_format(self):
        ...
        connection = test_env.get_connection()
        expected_value = "yaspy.Connection to %s@%s" % \
    ...
    def test_1123_closed_connection_attributes(self):
        ...
        for name in attr_names:
            self.assertRaises(yaspy.InterfaceError, getattr, connection,
                    name)
    ...
    def test_1128_exception_creating_global_txn_after_local_txn(self):
        ...
        id_ = random.randint(0, 2 ** 128)
        xid = (0x1234, "%032x" % id_, "%032x" % 9)
        self.assertRaises(yaspy.DatabaseError, connection.begin, *xid)
    ...
    def test_1130_cancel(self):
        ...
        try:
            with conn.cursor() as cursor:
                self.assertRaises(yaspy.OperationalError, cursor.callproc,
    ...
    def test_1135_calltimeout(self):
        ...
        self.assertRaises(yaspy.DatabaseError, conn.cursor().callproc,
                          test_env.get_sleep_proc_name(), [2])
