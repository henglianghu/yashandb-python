...
class TestCase(test_env.BaseTestCase):
    ...
    def test_3800(self):
        ...
        self.assertRaises(yaspy.NotSupportedError, self.cursor.execute, sql,
    ...
    def test_3803(self):
        ...
        self.assertRaises(yaspy.NotSupportedError, cursor_two.execute,
    ...
    def test_3804(self):
        ...
        self.assertRaises(yaspy.NotSupportedError, other_cursor.execute,
