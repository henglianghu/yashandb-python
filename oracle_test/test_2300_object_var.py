...
class TestCase(test_env.BaseTestCase):
    ...
    def test_2300_bind_null_in(self):
        ...
        var = self.cursor.var(yaspy.DB_TYPE_OBJECT, typename="UDT_OBJECT")
    ...
    def test_2304_fetch_data(self):
        ...
        self.cursor.execute("""
                ...
                order by IntCol""")
        expected_value = [
            ('INTCOL', yaspy.DB_TYPE_NUMBER, 10, None, 9, 0, False),
            ('OBJECTCOL', yaspy.DB_TYPE_OBJECT, None, None, None, None,
                    True),
            ('ARRAYCOL', yaspy.DB_TYPE_OBJECT, None, None, None, None, True)
        ]
        ...
        expected_value = (
            ...
            25.25,
            50.125,
            yaspy.Timestamp(2007, 3, 6, 0, 0, 0),
            yaspy.Timestamp(2008, 9, 12, 16, 40),
            yaspy.Timestamp(2009, 10, 13, 17, 50),
            yaspy.Timestamp(2010, 11, 14, 18, 55),
            'Short CLOB value',
            'Short NCLOB Value',
            b'Short BLOB value',
            (11, 'Sub object 1'),
        ...
        expected_value = (
            ...
            86.5,
            192.125,
            yaspy.Timestamp(2007, 6, 21, 0, 0, 0),
            yaspy.Timestamp(2007, 12, 13, 7, 30, 45),
            yaspy.Timestamp(2017, 6, 21, 23, 18, 45),
            yaspy.Timestamp(2017, 7, 21, 8, 27, 13),
    ...
    def test_2305_get_object_type(self):
        ...
        expected_attr_types = [
            yaspy.DB_TYPE_NUMBER,
            yaspy.DB_TYPE_VARCHAR,
            yaspy.DB_TYPE_CHAR,
            yaspy.DB_TYPE_NVARCHAR,
            yaspy.DB_TYPE_NCHAR,
            yaspy.DB_TYPE_RAW,
            yaspy.DB_TYPE_NUMBER,
            yaspy.DB_TYPE_NUMBER,
            ...
            yaspy.DB_TYPE_NUMBER,
            yaspy.DB_TYPE_NUMBER,
            yaspy.DB_TYPE_BINARY_FLOAT,
            yaspy.DB_TYPE_BINARY_DOUBLE,
            yaspy.DB_TYPE_DATE,
            yaspy.DB_TYPE_TIMESTAMP,
            yaspy.DB_TYPE_TIMESTAMP_TZ,
            yaspy.DB_TYPE_TIMESTAMP_LTZ,
            yaspy.DB_TYPE_CLOB,
            yaspy.DB_TYPE_NCLOB,
            yaspy.DB_TYPE_BLOB,
    ...
    def test_2307_round_trip_object(self):
        ...
        expected_value = (
            ...
            14.25,
            29.1625,
            yaspy.Timestamp(2017, 5, 9, 0, 0, 0),
            yaspy.Timestamp(2017, 5, 9, 9, 41, 13),
            yaspy.Timestamp(1986, 8, 2, 15, 27, 38),
            yaspy.Timestamp(1999, 11, 12, 23, 5, 2),
            'A short CLOB',
            'A short NCLOB',
            b'A short BLOB',
            (23, 'Substring value'),
    ...
    def test_2308_invalid_type_object(self):
        ...
        self.assertRaises(yaspy.DatabaseError, self.connection.gettype,
    ...
    def test_2309_appending_wrong_object_type(self):
        ...
        self.assertRaises(yaspy.DatabaseError, collection_obj.append,
                          array_obj)
    ...
    def test_2312_setting_attr_wrong_object_type(self):
        ...
        self.assertRaises(yaspy.DatabaseError, setattr, obj,
    ...
    def test_2313_setting_var_wrong_object_type(self):
        ...
        wrong_obj = wrong_obj_type.newobject()
        var = self.cursor.var(yaspy.DB_TYPE_OBJECT, typename="UDT_OBJECT")
        self.assertRaises(yaspy.DatabaseError, var.setvalue, 0, wrong_obj)
