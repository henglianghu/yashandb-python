...
class TestCase(test_env.BaseTestCase):
    ...
    def __deq_in_thread(self, results):
        ...
        queue.deqoptions.navigation = yaspy.DEQ_FIRST_MSG
    ...
    def test_2802_deq_with_wait(self):
        ...
        messages = [self.connection.msgproperties(payload=d) \
                    for d in RAW_PAYLOAD_DATA]
        queue.enqoptions.visibility = yaspy.ENQ_IMMEDIATE
        queue.enqmany(messages)
        thread.join()
    ...
    def test_2804_enq_and_deq_visibility(self):
        ...
        queue.enqoptions.visibility = yaspy.ENQ_ON_COMMIT
        ...
        other_queue.deqoptions.wait = yaspy.DEQ_NO_WAIT
        other_queue.deqoptions.visibility = yaspy.DEQ_ON_COMMIT
        ...
        queue.enqoptions.visibility = yaspy.ENQ_IMMEDIATE
        other_queue.deqoptions.visibility = yaspy.DEQ_IMMEDIATE
        queue.enqmany([props1, props2])
        messages = other_queue.deqmany(5)
