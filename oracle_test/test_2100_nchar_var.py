...
class TestCase(test_env.BaseTestCase):
    ...
    def test_2101_bind_unicode(self):
        ...
        # self.cursor.setinputsizes(value=yaspy.DB_TYPE_NVARCHAR)
        self.cursor.execute("""
    ...
    def test_2102_bind_different_var(self):
        ...
        retval_1 = self.cursor.var(yaspy.NVARCHAR, 30)
        retval_2 = self.cursor.var(yaspy.NVARCHAR, 30)
    ...
    def test_2103_bind_unicode_after_number(self):
        ...
        unicode_val = self.cursor.var(yaspy.NVARCHAR)
        unicode_val.setvalue("Unicode \u3042 6")
        self.cursor.execute("""
                select * from TestUnicodes
                where UnicodeCol = :value""",
                value=unicode_val)
    ...
    def test_2104_bind_unicode_array_direct(self):
        ...
        array_var = self.cursor.arrayvar(yaspy.DB_TYPE_NVARCHAR, array)
        statement = """
                begin
    ...
    def test_2105_bind_unicode_array_by_sizes(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        self.cursor.setinputsizes(array = [yaspy.DB_TYPE_NVARCHAR, 10])
        array = [r[1] for r in self.raw_data]
        self.cursor.execute("""
                begin
    ...
    def test_2106_bind_unicode_array_by_var(self):
        ...
        return_value = self.cursor.var(yaspy.NUMBER)
        array = self.cursor.arrayvar(yaspy.DB_TYPE_NVARCHAR, 10, 20)
    ...
    def test_2107_bind_in_out_unicode_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.DB_TYPE_NVARCHAR, 10, 100)
    ...
    def test_2108_bind_out_unicode_array_by_var(self):
        ...
        array = self.cursor.arrayvar(yaspy.DB_TYPE_NVARCHAR, 6, 100)
    ...
    def test_2110_bind_out_set_input_sizes_by_type(self):
        ...
        bind_vars = self.cursor.setinputsizes(value=yaspy.DB_TYPE_NVARCHAR)
    ...
    def test_2112_bind_out_var(self):
        ...
        var = self.cursor.var(yaspy.NVARCHAR)
        self.cursor.execute(r"""
                begin
    ...
    def test_2114_cursor_description(self):
        ...
        expected_value = [
            ...
            ('UNICODECOL', 27, 41, 40, 0, 0, 0),
            ('FIXEDUNICODECOL', 25, 81, 80, 0, 0, 0),
            ('NULLABLECOL', 27, 101, 100, 0, 0, 1)
        ]
