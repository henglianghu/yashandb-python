...
class TestCase(test_env.BaseTestCase):
    ...
    def test_1300_bind_cursor(self):
        ...
        expected_value = [
            ('STRINGVALUE', yaspy.CHAR, 1, varchar_ratio, None,
                    None, True)
        ]
    ...
    def test_1301_bind_cursor_in_package(self):
        ...
        varchar_ratio, nvarchar_ratio = test_env.get_charset_ratios()
        expected_value = [
            ('INTCOL', yaspy.NUMBER, 10, None, 9, 0, False),
            ('STRINGCOL', yaspy.VARCHAR, 20, 20 * varchar_ratio,
                    None, None, False)
        ]
        self.assertEqual(cursor.description, expected_value)
    ...
    def test_1302_bind_self(self):
        ...
        self.assertRaises(yaspy.DatabaseError, cursor.execute, sql,
                          pcursor=cursor)
    ...
    def test_1304_fetch_cursor(self):
        ...
        expected_value = [
            ('INTCOL', yaspy.NUMBER, 10, None, 9, 0, False),
            ('CURSORVALUE', yaspy.CURSOR, None, None, None, None,
                    True)
        ]
