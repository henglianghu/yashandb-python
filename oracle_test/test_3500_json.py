...
class TestCase(test_env.BaseTestCase):
    ...
    def __bind_scalar_as_json(self, data):
        ...
        out_var = self.cursor.var(yaspy.DB_TYPE_JSON,
                                  arraysize=len(data))
        self.cursor.setinputsizes(None, yaspy.DB_TYPE_JSON, out_var)
    ...
    def test_3500_insert_and_fetch_single_json(self):
        ...
        self.cursor.execute("truncate table TestJson")
        # self.cursor.setinputsizes(None, yaspy.DB_TYPE_JSON)
    ...
    def test_3501_execute_with_dml_returning(self):
        ...
        self.cursor.execute("truncate table TestJson")
        json_out = self.cursor.var(yaspy.JSON)
        # self.cursor.setinputsizes(None, yaspy.DB_TYPE_JSON, json_out)
        self.cursor.execute("""
                insert into TestJson values (:1, :2)
        ...
        self.assertEqual(
            json_out.getvalue(),
            '{"employees":[{"employee1":{"city":"Delhi","name":"John"}},{"employee2":{"city":"Mumbai","name":"Matthew"}},{"employee3":{"city":"Bangalore","name":"James"}}]}',
        )
    ...
    def test_3503_executemany_with_dml_returning(self):
        ...
        out_json_var = self.cursor.var(yaspy.DB_TYPE_JSON,
                                       arraysize=len(int_values))
        self.cursor.setinputsizes(None, yaspy.DB_TYPE_JSON, out_int_var,
                                  out_json_var)
    ...
    def test_3506_datetime(self):
        ...
        data = [
            ...
            yaspy.Timestamp(2002, 12, 13, 9, 36, 0),
